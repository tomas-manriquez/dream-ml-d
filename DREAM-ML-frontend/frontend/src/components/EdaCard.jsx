...
const EdaCard = () => {
  ...
  const getCurrentState = () => {
    ...
    if (edaGenerationInProgress) {
      return {
        type: 'processing',
        message: 'Generando reportes YData Profiling y Sweetviz...',
  ...
  const handleGenerateEda = async () => {
    ...
    try {
      const response = await axios.post("/generate-eda/", {
  ...
  return (
    ...
    >
      <CardContent>
        ...
        >
          Analiza automáticamente tus datos con <strong>YData Profiling</strong> y{" "}
          <strong>Sweetviz</strong>. Se generará el EDA del archivo <strong>processed_eda.csv</strong>.
        </Typography>
